...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await fetch("/landing-page/api/contact", {
        method: "POST",
      ...
      <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-3 text-slate-400 text-sm sm:text-base">
            Have questions about station onboarding, playout API integration, or
            listener accounts? Our support team is available 24/7.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <a
              ...
              className="block p-6 rounded-2xl bg-[#0c1424] border border-white/10 hover:border-[#25D366]/50 transition-all group"
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-white font-bold group-hover:text-[#25D366] transition-colors">
                    WhatsApp Live Chat
                  </h3>
              ...
              <p className="text-xs text-slate-400 leading-relaxed">
                ...
                onboarding or broadcaster troubleshooting.
              </p>
            </a>

            {/* Email Support */}
            <div className="p-6 rounded-2xl bg-[#0c1424] border border-white/10">
              <div className="flex items-center gap-3 mb-3">
                <div className="p-3 rounded-xl bg-[#1e60f2]/20 text-[#38bdf8]">
              ...
              <p className="text-xs text-slate-400 leading-relaxed mb-3">
                Send technical inquiries, station proposals, or partnership
                agreements.
              </p>
              <a
                href="mailto:support@studiopass.app"
                className="text-sm font-semibold text-[#38bdf8] hover:text-white"
              >
            ...
            <div className="p-6 rounded-2xl bg-[#0c1424] border border-white/10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  <h3 className="text-white font-bold">Broadcaster FAQ</h3>
                  <p className="text-xs text-slate-400">Self-serve guides</p>
                </div>
              </div>
              <p className="text-xs text-slate-400 leading-relaxed mb-3">
                Browse our detailed knowledge base covering playout systems,
                billing split, and mobile app features.
              </p>
              <Link
                href="/#faq"
                className="text-xs font-semibold text-[#38bdf8] hover:text-white inline-flex items-center gap-1"
              >
          ...
          {/* Contact Form */}
          <div className="lg:col-span-2 p-6 sm:p-8 rounded-2xl bg-[#0c1424] border border-white/10 shadow-2xl">
            {!submitted ? (
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full appearance-none rounded-xl bg-[#080c15] border border-white/10 pl-3.5 pr-10 py-2.5 text-sm text-white focus:outline-none focus:border-[#38bdf8] cursor-pointer"
                      >
                        {OPERATING_COUNTRIES.map((c) => (
                          <option key={c.code} value={c.name} className="bg-[#080c15] text-white">
                            {c.flag} {c.name}
                          </option>
                        ))}
                      </select>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="TV Playout & API Integration">
                          TV Playout & API Integration
                        </option>
                        <option value="Billing & Mobile Money Question">
                          Billing & Mobile Money Question
                        </option>
                        <option value="Listener Mobile App Feedback">
                          Listener Mobile App Feedback
                        </option>
              ...
              <div className="text-center py-12 space-y-4">
                ...
                <p className="text-slate-300 text-sm max-w-md mx-auto">
                  Thank you for reaching out. A support engineer or partnership
